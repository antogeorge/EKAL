...
class __TwigTemplate_a92d404851743d6145f38051999e946e92e7e4178985f9b3d818be91c49ced68 extends Twig_Template
{
...
\t</div>
    ...
    {
        return new Twig_Source("<h3>{{ comments_header }}</h3>
<div class=\"career-box\">
\t<p>{{ comments_body }}</p>
                    
<a href=\"#\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#exampleComments\">{{ comments_button }}</a>
...
\t
<div class=\"modal-header\">
\t<h5 class=\"modal-title\" id=\"exampleModalLongTitle\">{{ comments_form_header }}</h5>
\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">
\t<span aria-hidden=\"true\">&times;</span>
\t</button>
</div> 
...
<div class=\"modal-body\">
<div class=\"row\">
  <div class=\"col-md-12\"><p> {{ comments_form_body }} </p></div>
</div>
<!--<div data-alerts=\"alerts\"  data-fade=\"18000\"></div>-->
<div data-alerts=\"alerts\"></div>
...
</div>", "themes/custom/aljabr/templates/form/form--aljabr-comments.html.twig", "C:\\xampp\\htdocs\\aljabr\\themes\\custom\\aljabr\\templates\\form\\form--aljabr-comments.html.twig");
    }
}

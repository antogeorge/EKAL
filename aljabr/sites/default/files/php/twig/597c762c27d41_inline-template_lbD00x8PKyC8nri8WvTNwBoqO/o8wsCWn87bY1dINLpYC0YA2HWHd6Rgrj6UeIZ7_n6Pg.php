...
class __TwigTemplate_88f85e7ea184d400b7c35af887c97f192074425f1381250d0990e9709ffa8edc extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}{{ name }}", "{# inline_template_start #}{{ name }}", "");
    }
}

...
class __TwigTemplate_82d41f1103c2af6f271d02bb526d881dee9aa2d4a3eb4072bbbd7192769fdfd2 extends Twig_Template
{
...
\t\t\t</form>
    ...
    {
        return new Twig_Source("<h3>{{ subscribemail_header }}</h3>
<div class=\"career-box\">
<p> {{ subscribemail_body }}</p>

                    
<a href=\"#\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#exampleModalLong\">{{ subscribemail_button }}</a>            
...
<div class=\"modal fade\" id=\"exampleModalLong\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">
  <div class=\"modal-dialog\" role=\"document\">
    <div class=\"modal-content offer-model-one\">
      <div class=\"modal-header\">
        <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">{{ subscribemail_form_header }}</h5>
      ...
      <div class=\"modal-body\">
         <div class=\"row\">
                  <div class=\"col-md-12\"><p> {{ subscribemail_form_body }} </p></div>
              </div>
\t\t\t  
\t\t\t<div data-alerts=\"alerts\"></div>
...
</div>", "themes/custom/aljabr/templates/form/form--aljabr-mail.html.twig", "C:\\xampp\\htdocs\\aljabr\\themes\\custom\\aljabr\\templates\\form\\form--aljabr-mail.html.twig");
    }
}

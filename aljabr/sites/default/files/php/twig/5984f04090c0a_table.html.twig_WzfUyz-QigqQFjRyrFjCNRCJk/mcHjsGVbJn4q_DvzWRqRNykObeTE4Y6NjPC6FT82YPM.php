...
$context["cell"], "active_table_sort", array())) ? ("is-active") : ("")));
                ...
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["cell"], "attributes", array()), "addClass", array(0 => (isset($context["cell_classes"]) ? $context["cell_classes"] : null)), "method"), "html", null, true));
                echo ">";
                // line 69
...
";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/dataset/table.html.twig", "/home/ameencoi/public_html/aljabr.com/core/themes/classy/templates/dataset/table.html.twig");
    }
}
